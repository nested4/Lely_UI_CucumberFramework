...
public class BrowserUtils {
    ...
    public static String getScreenshot(String name) throws IOException {
        ...
        //   ((TakesScreenshot)Driver.getDriver()).getScreenshotAs(OutputType.FILE);
...
*/
    ...
    public static void clickRadioButton(List<WebElement> radioButtons,String attributeName, String expectedAttributeValue){

        for (WebElement each : radioButtons) {

            if (each.getAttribute(attributeName).equalsIgnoreCase(expectedAttributeValue)){
                each.click();
            }
        }
    }
